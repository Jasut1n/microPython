<h1 align="center'>Install for Linux Shell</h1>
           ...
           Once inside the virtual environment, use pip to install esptool. esptool will be used to upload the MicroPython .bin firmware file onto the ESP8266-based microcontroller.
